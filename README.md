...
- 100% Customized
- 100% Free
- **7 built-in plugins** for dynamic variables: GitHub stars, npm downloads, RSS latest post, Bluesky/Mastodon/Dev.to follower counts, and a Countdown helper. Add your own with one Ruby file — or have Claude Code scaffold one for you ([guide](#plugins))
